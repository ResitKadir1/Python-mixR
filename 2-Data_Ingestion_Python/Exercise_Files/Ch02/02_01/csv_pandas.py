...
def iter_df(file_name):
    yield from pd.read_csv(
        'taxi.csv.bz2', parse_dates=time_cols, chunksize=100) #takes 100 records for each time
...
#pandas convert all data type automatically into relevant onces, except timestaps#
#csv_pv csv_pandas